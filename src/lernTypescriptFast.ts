...
// nameless / annonymous function (they are stored under a variable with a name but the function itself is nameless)
...
let f5 = (i: number) => i * i;
// "Fat arrow" syntax:
    // no funtion statement
    // return type inferred implicit
    // no return keyword
    //parameter type inferred implicit: any
let f6 = i=>i*i
